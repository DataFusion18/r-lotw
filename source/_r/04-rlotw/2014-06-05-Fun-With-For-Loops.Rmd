...
```{r}
my_behav_files <- list.files(path='/Users/josh.london/@work/r-lotw/source/_r/04-rlotw/behav-data',
                             # on OS X path='~/@work/r-lotw/source/_r/04-rlotw/behav-data' is also valid
...
**list.files()** requires us to, at a minimum, pass a file path character for the directory/folder we are interested in. In this case, I provided the full file path (`path='/Users/josh.london/@work/r-lotw/source/_r/04-rlotw/behav-data'`). Many of you have had difficulties troubleshooting issues related to file paths so this is another opportunity for you to wrap your head around the concept. Since my R Markdown file is saved within the '**/Users/josh.london/@work/r-lotw/source/_r/04-rlotw**' folder, I could also have provided the relative path (`path='behav-data'`).
